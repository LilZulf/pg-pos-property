...
@section('breadcrumb')
    <h4 class="mb-sm-0">Transaction Detail</h4>
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            <li class="breadcrumb-item"><a href="{{ route('qris.index') }}">QRIS Transaction</a></li>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title flex-grow-1 mb-0">{{ $transaction->ref }}</h5>
                        ...
                        <table class="table table-nowrap align-middle table-borderless mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15">{{ $transaction->ref }}</h5>
                                    ...
                                    <td>
                                        @if($transaction->transaction_method_id == 1)
                                            <span class="">QRIS</span>
                                        @else
                                            <span class="">Virtual Account</span>
                                        @endif
                                    </td>
                                        ...
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                <tr class="border-top border-top-dashed">
                                                    ...
                                                    <th class="text-end">
                                                        Rp.{{ number_format($transaction->amount, 0, ',', '.') }}</th>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
                                ...
                                <div class="accordion-item border-0">
                                    <div class="accordion-header" id="headingTwo">
                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h6 class="fs-15 mb-1 fw-semibold">{{ $log->result }} - <span
                                                            class="fw-normal">{{ $log->updated_at->format('l, d F Y') }}</span>
                                                    </h6>
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body ms-2 ps-5 pt-0">
                                            <h6 class="mb-1">{{ $log->payload }}</h6>
                                            <p class="text-muted mb-0">{{ $log->updated_at->format('D, d M Y - g:iA') }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
